<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li>
            <?= $this->Html->link('<i class="fa fa-dashboard"></i> ' . __('Voltar'), ['controller' => 'actividades', 'action' => 'adicionar'], ['escape' => false])?>
        </li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <?php echo $this->Html->link(__('Actividades'), ['controller' => 'actividades', 'action' => 'adicionar', $trabalho->id]); ?>
                </div>
                <!-- /.box-body -->
            </div>
            <!-- /.box -->
