...
<?php echo $this->fetch('content'); ?>
      <div class="form-group has-feedback">
        <?php echo $this->Form->input('email', ['class' => 'form-control', 'placeholder' => 'Email', 'required']); ?>
      </div>
      <div class="form-group has-feedback">
        <?php echo $this->Form->input('password', ['class' => 'form-control', 'placeholder' => 'Senha', 'required']); ?>
      </div>
